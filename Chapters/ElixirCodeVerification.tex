...
$$E =  (x = 2;x = 3 + x; y = x * x * z)$$
$$\mathit{ssa}(E) = (x_1 = 2;x_2 = 3 + x_1;y_1 = x_2 * x_2 * z)$$
...
\[
\begin{array}{l}
\mathit{verification}(E) = [\blockE~S_i \mid i \leftarrow [1..n]] \\
\qquad 
\begin{array}{ll}
...
function parameters are unknown at this point, it is not possible to know in 
...
shown in \ref{sec:verificationprocess}.
