...
In the following, given a set $A$, we use the notation $[A]$ to denote the set of 
...
This models appropriately the short-circuit semantics of the \verb|case| construct
