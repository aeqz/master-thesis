...
We start by providing its formal syntax, the built-in prelude that we have
defined for modelling the Elixir semantics, and its translation into L0
expressions.  Then, we show some examples with our current implementation and
give an overview of its details.
...
For example, this would be the translation of the tuple $\{2, x\}$:
...
\end{array}
\]
\caption{Translation of the list L1 expressions into L0}
\label{fig:listtr}
\end{figure}

For example, this would be the translation of the list $[2, x]$:
...
\end{array}
\]
\caption{Translation of the function application L1 expression into L0}
\label{fig:functr}
\end{figure}
...
\end{array}
\]
\caption{Translation of the $\mathbf{and}$ L1 expression into L0}
\label{fig:andtr}
\end{figure}
...
\end{array}
\]
\caption{Translation of the $\mathbf{or}$ L1 expression into L0}
\label{fig:ortr}
\end{figure}
...
\end{array}
\]
\caption{Translation of the $\mathbf{unfold}$ L1 statement into L0}
\label{fig:unfoldtr}
\end{figure}
